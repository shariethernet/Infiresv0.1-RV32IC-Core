...
\TLV
   ...
   *failed = 1'b0;
   ...
   //  o CPU visualization
   |cpu
      \source /raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/c1719d5b338896577b79ee76c2f443ca2a76e14f/tlvlib/riscvshelllib.tlv 16   // Instantiated from top.tlv, 219 as: m4+imem(@1)    // Args: (read stage)
      ...
      \source /raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/c1719d5b338896577b79ee76c2f443ca2a76e14f/tlvlib/riscvshelllib.tlv 33   // Instantiated from top.tlv, 220 as: m4+rf(@2, @3)  // Args: (read stage, write stage) - if equal, no register bypass is required
         // Reg File
         @3
            /xreg[31:0]
      ...
      \source /raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/c1719d5b338896577b79ee76c2f443ca2a76e14f/tlvlib/riscvshelllib.tlv 50   // Instantiated from top.tlv, 221 as: m4+dmem(@4)    // Args: (read/write stage)
         // Data Memory
         @4
            /dmem[15:0]
