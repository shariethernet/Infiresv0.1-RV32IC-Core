...
`include "top_gen.sv" //_\TLV
   ...
   //_|cpu
      ...
      //Fetch
         ...
         assign CPU_pc_a0[31:0] = (CPU_reset_a1) ? '0 : 
                     (CPU_taken_br_a3) ? CPU_br_tgt_pc_a3 : CPU_inc_pc_a1;
         
         assign CPU_imem_rd_en_a0 = !CPU_reset_a0;
         assign CPU_imem_rd_addr_a0[31:0] = CPU_pc_a0[3+1:2];
      ...
      //       other than those specifically expected in the labs. You'll get strange errors for these.
         ...
         `BOGUS_USE(CPU_is_beq_a3 CPU_is_bne_a3 CPU_is_blt_a3 CPU_is_bge_a3 CPU_is_bltu_a3 CPU_is_bgeu_a3)
   ...
   //  o CPU visualization
   //_|cpu
      `line 17 "/raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/c1719d5b338896577b79ee76c2f443ca2a76e14f/tlvlib/riscvshelllib.tlv" 1   // Instantiated from top.tlv, 219 as: m4+imem(@1)    // Args: (read stage)
      ...
      `line 220 "top.tlv" 2
      `line 34 "/raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/c1719d5b338896577b79ee76c2f443ca2a76e14f/tlvlib/riscvshelllib.tlv" 1   // Instantiated from top.tlv, 220 as: m4+rf(@2, @3)  // Args: (read stage, write stage) - if equal, no register bypass is required
         // Reg File
         //_@3
      ...
      `line 221 "top.tlv" 2
      `line 51 "/raw.githubusercontent.com/stevehoover/RISCVMYTHWorkshop/c1719d5b338896577b79ee76c2f443ca2a76e14f/tlvlib/riscvshelllib.tlv" 1   // Instantiated from top.tlv, 221 as: m4+dmem(@4)    // Args: (read/write stage)
         // Data Memory
         //_@4
